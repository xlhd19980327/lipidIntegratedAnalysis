...
CalculateHyperScore_cus <- function (mSetObj = NA) 
{
  ...
  MetaboAnalystR:::fast.write.csv(oraDataRes, file = "~/temp/msea_ora_result.csv")
...
#bar plot
mSet2<-PlotORA(mSet2, "~/temp/ora_0_", "net", "png", 72, width=NA)
#dot plot
mSet2<-PlotEnrichDotPlot(mSet2, "ora", "~/temp/ora_dot_0_", "png", 72, width=NA)
